...
@ahelp.kb='%Wu%nsage%K:%n /kb <nick> will kick and ban nick from current channel.';
...
@ahelp.bankick='%Wu%nsage%K:%n /bankick <nick> will ban and kick nick from current channel.';
...
@ahelp.k='%Wu%nsage%K:%n /k nick <reason> kicks nick with reason';
...
@ahelp.bk='%Wu%nsage%K:%n /bk <nick> <reason> bankicks nick for reason';
...
@ahelp.mop='%Wu%nsage%K:%n /mop mass ops current channel';
...
awecho  ---------------------------------------------------------------------;
	...
	aecho  | $center($_ohcenter a m n e s i a c   h e l p) $[15]{" "}|;
